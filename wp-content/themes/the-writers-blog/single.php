					...
					<?php
						...
						while ( have_posts() ) : the_post(); 
							...
							the_post_navigation( array(
								'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'the-writers-blog' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'the-writers-blog' ) . '</span>',
								'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'the-writers-blog' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'the-writers-blog' ) . '</span>',
							) );
