...
class the_writers_blog_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $the_writers_blog_Icon_Changer_array = the_writers_blog_Icon_Changer_array();
                    foreach ($the_writers_blog_Icon_Changer_array as $the_writers_blog_Icon_Changer) {
                            $icon_class = $this->value() == $the_writers_blog_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($the_writers_blog_Icon_Changer).'"></i>
                            <span class="the-writers-blog-social-class">'.esc_attr($the_writers_blog_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function the_writers_blog_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'the-writers-blog-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'the_writers_blog_icon_customize_js' );

if(!function_exists('the_writers_blog_Icon_Changer_array')){
    function the_writers_blog_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
