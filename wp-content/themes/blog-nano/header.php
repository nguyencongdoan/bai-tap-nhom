...
<div id="page" class="site">
    <a class="skip-link screen-reader-text"
       href="#content"><?php esc_html_e('Skip to content', 'blog-nano'); ?></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php if(is_page() || is_single() ){ ?>
                            ...
                            <h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'blog-nano' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
        
                            <?php }elseif( is_404() ){ ?>
        
                            <h1 class="page-title"><?php echo esc_html__( 'Page Not Found: 404', 'blog-nano'); ?></h1>
